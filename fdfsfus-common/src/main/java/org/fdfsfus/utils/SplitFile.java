...
public class SplitFile {
    public static String file="/Users/yanziming/Documents/mike/fdfs/asd/IMG_1155.MP4"; //文件的路径
    public static String outfile="/Users/yanziming/Documents/mike/fdfs/asd/out.MP4"; //文件的路径
    ...
    public static void getSplitFile() {
        String file1 = "/Users/yanziming/Documents/mike/fdfs/asd/IMG_1155.MP4"; //文件的路径
        int count1=10;   //将文件切割成多少份
        String file = file1; //文件的路径
